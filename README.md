...
***Схема `Task` (задача) должна содержать следующие поля:***
...
| Дата создания (автогенерация)|*|
| Дата обновления (автогенерация)||


***Схема `Group` (группа) должна содержать следующие поля:***
| Поле                        | Обязательность|
|-----------------------------|---------------|
| Идентификатор группы|*|
| Имя|*|
